...
do -- Set properties
    ...
    objects["Instance350"] = Instance.new("ModuleScript"); -- ScriptExporter
    objects["Instance350"]["Parent"] = objects["Instance9"];
    objects["Instance350"]["Name"] = "ScriptExporter";
    ...
    objects["Instance302"] = Instance.new("UIScale"); -- MobileScale
    objects["Instance302"]["Name"] = "MobileScale";
    objects["Instance302"]["Parent"] = objects["Instance1"];
    objects["Instance302"]["Scale"] = 1;
    ...
    objects["Instance303"] = Instance.new("Frame"); -- FloatingActionButton
    objects["Instance303"]["LayoutOrder"] = 0;
    objects["Instance303"]["Active"] = false;
    objects["Instance303"]["Parent"] = objects["Instance1"];
    objects["Instance303"]["AnchorPoint"] = Vector2.new(1, 1);
    objects["Instance303"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance303"]["ZIndex"] = 100;
    objects["Instance303"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance303"]["Size"] = UDim2.new(0, 56, 0, 56);
    objects["Instance303"]["Draggable"] = false;
    objects["Instance303"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance303"]["ClipsDescendants"] = false;
    objects["Instance303"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance303"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance303"]["BackgroundTransparency"] = 0;
    objects["Instance303"]["BorderSizePixel"] = 0;
    objects["Instance303"]["Rotation"] = 0;
    objects["Instance303"]["Transparency"] = 0;
    objects["Instance303"]["Name"] = "FloatingActionButton";
    objects["Instance303"]["SelectionOrder"] = 0;
    objects["Instance303"]["Visible"] = false;
    objects["Instance303"]["Selectable"] = false;
    objects["Instance303"]["Position"] = UDim2.new(1, -20, 1, -20);
    objects["Instance303"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);

    objects["Instance304"] = Instance.new("UICorner"); -- FABCorner
    objects["Instance304"]["Parent"] = objects["Instance303"];
    objects["Instance304"]["Name"] = "UICorner";
    objects["Instance304"]["CornerRadius"] = UDim.new(0.5, 0);

    objects["Instance305"] = Instance.new("UIStroke"); -- FABStroke
    objects["Instance305"]["Enabled"] = true;
    objects["Instance305"]["Transparency"] = 0;
    objects["Instance305"]["Name"] = "UIStroke";
    objects["Instance305"]["LineJoinMode"] = Enum.LineJoinMode.Round;
    objects["Instance305"]["Parent"] = objects["Instance303"];
    objects["Instance305"]["Thickness"] = 1;
    objects["Instance305"]["Color"] = Color3.new(0.160784, 0.505882, 0.333333);
    objects["Instance305"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;

    objects["Instance306"] = Instance.new("ImageLabel"); -- FABIcon
    objects["Instance306"]["Visible"] = true;
    objects["Instance306"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance306"]["Size"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance306"]["ImageTransparency"] = 0;
    ...
    objects["Instance306"]["ImageRectOffset"] = Vector2.new(0, 0);
    objects["Instance306"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance306"]["Image"] = "rbxassetid://7733658504";
    objects["Instance306"]["TileSize"] = UDim2.new(1, 0, 1, 0);
    objects["Instance306"]["ImageRectSize"] = Vector2.new(0, 0);
    objects["Instance306"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance306"]["ZIndex"] = 101;
    objects["Instance306"]["BorderSizePixel"] = 0;
    objects["Instance306"]["SliceCenter"] = Rect.new(0, 0, 0, 0);
    objects["Instance306"]["Draggable"] = false;
    objects["Instance306"]["ScaleType"] = Enum.ScaleType.Stretch;
    objects["Instance306"]["ResampleMode"] = Enum.ResamplerMode.Default;
    objects["Instance306"]["ClipsDescendants"] = false;
    objects["Instance306"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance306"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance306"]["LayoutOrder"] = 0;
    objects["Instance306"]["ImageColor3"] = Color3.new(1, 1, 1);
    objects["Instance306"]["Rotation"] = 0;
    objects["Instance306"]["Transparency"] = 0;
    objects["Instance306"]["Name"] = "FABIcon";
    objects["Instance306"]["SelectionOrder"] = 0;
    objects["Instance306"]["SliceScale"] = 1;
    objects["Instance306"]["Selectable"] = false;
    objects["Instance306"]["Active"] = false;
    objects["Instance306"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance307"] = Instance.new("UIAspectRatioConstraint"); -- FABAspect
    objects["Instance307"]["AspectRatio"] = 1;
    objects["Instance307"]["Name"] = "UIAspectRatioConstraint";
    objects["Instance307"]["Parent"] = objects["Instance303"];
    objects["Instance307"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["Instance307"]["DominantAxis"] = Enum.DominantAxis.Width;

    objects["Instance308"] = Instance.new("Frame"); -- BottomNavBar
    objects["Instance308"]["LayoutOrder"] = 0;
    objects["Instance308"]["Active"] = false;
    objects["Instance308"]["Parent"] = objects["Instance1"];
    objects["Instance308"]["AnchorPoint"] = Vector2.new(0.5, 1);
    objects["Instance308"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance308"]["ZIndex"] = 50;
    objects["Instance308"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance308"]["Size"] = UDim2.new(1, 0, 0, 60);
    objects["Instance308"]["Draggable"] = false;
    objects["Instance308"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance308"]["ClipsDescendants"] = false;
    objects["Instance308"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance308"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance308"]["BackgroundTransparency"] = 0;
    objects["Instance308"]["BorderSizePixel"] = 0;
    objects["Instance308"]["Rotation"] = 0;
    objects["Instance308"]["Transparency"] = 0;
    objects["Instance308"]["Name"] = "BottomNavBar";
    objects["Instance308"]["SelectionOrder"] = 0;
    objects["Instance308"]["Visible"] = false;
    objects["Instance308"]["Selectable"] = false;
    objects["Instance308"]["Position"] = UDim2.new(0.5, 0, 1, 0);
    objects["Instance308"]["BackgroundColor3"] = Color3.new(0.105882, 0.105882, 0.105882);

    objects["Instance309"] = Instance.new("UICorner"); -- BottomNavCorner
    objects["Instance309"]["Parent"] = objects["Instance308"];
    objects["Instance309"]["Name"] = "UICorner";
    objects["Instance309"]["CornerRadius"] = UDim.new(0.025, 0);

    objects["Instance310"] = Instance.new("UIStroke"); -- BottomNavStroke
    objects["Instance310"]["Enabled"] = true;
    objects["Instance310"]["Transparency"] = 0.5;
    objects["Instance310"]["Name"] = "UIStroke";
    objects["Instance310"]["LineJoinMode"] = Enum.LineJoinMode.Round;
    objects["Instance310"]["Parent"] = objects["Instance308"];
    objects["Instance310"]["Thickness"] = 1;
    objects["Instance310"]["Color"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["Instance310"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;

    objects["Instance311"] = Instance.new("Frame"); -- BottomNavContent
    objects["Instance311"]["LayoutOrder"] = 0;
    objects["Instance311"]["Active"] = false;
    objects["Instance311"]["Parent"] = objects["Instance308"];
    objects["Instance311"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance311"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance311"]["ZIndex"] = 51;
    objects["Instance311"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance311"]["Size"] = UDim2.new(1, -20, 1, -10);
    objects["Instance311"]["Draggable"] = false;
    objects["Instance311"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance311"]["ClipsDescendants"] = true;
    objects["Instance311"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance311"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance311"]["BackgroundTransparency"] = 1;
    objects["Instance311"]["BorderSizePixel"] = 0;
    objects["Instance311"]["Rotation"] = 0;
    objects["Instance311"]["Transparency"] = 1;
    objects["Instance311"]["Name"] = "BottomNavContent";
    objects["Instance311"]["SelectionOrder"] = 0;
    objects["Instance311"]["Visible"] = true;
    objects["Instance311"]["Selectable"] = false;
    objects["Instance311"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance311"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance312"] = Instance.new("UIListLayout"); -- BottomNavLayout
    objects["Instance312"]["FillDirection"] = Enum.FillDirection.Horizontal;
    objects["Instance312"]["HorizontalAlignment"] = Enum.HorizontalAlignment.SpaceEvenly;
    objects["Instance312"]["VerticalFlex"] = Enum.UIFlexAlignment.None;
    objects["Instance312"]["Parent"] = objects["Instance311"];
    objects["Instance312"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
    objects["Instance312"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
    objects["Instance312"]["Name"] = "UIListLayout";
    objects["Instance312"]["Padding"] = UDim.new(0, 0);
    objects["Instance312"]["ItemLineAlignment"] = Enum.ItemLineAlignment.Automatic;
    objects["Instance312"]["HorizontalFlex"] = Enum.UIFlexAlignment.None;

    objects["Instance313"] = Instance.new("Frame"); -- ScriptExporter
    objects["Instance313"]["LayoutOrder"] = 0;
    objects["Instance313"]["Active"] = false;
    objects["Instance313"]["Parent"] = objects["Instance34"];
    objects["Instance313"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance313"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance313"]["ZIndex"] = 1;
    objects["Instance313"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance313"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["Instance313"]["Draggable"] = false;
    objects["Instance313"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance313"]["ClipsDescendants"] = false;
    objects["Instance313"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance313"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance313"]["BackgroundTransparency"] = 1;
    objects["Instance313"]["BorderSizePixel"] = 0;
    objects["Instance313"]["Rotation"] = 0;
    objects["Instance313"]["Transparency"] = 1;
    objects["Instance313"]["Name"] = "ScriptExporter";
    objects["Instance313"]["SelectionOrder"] = 0;
    objects["Instance313"]["Visible"] = false;
    objects["Instance313"]["Selectable"] = false;
    objects["Instance313"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["Instance313"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance314"] = Instance.new("Frame"); -- ExporterHeader
    objects["Instance314"]["LayoutOrder"] = 0;
    objects["Instance314"]["Active"] = false;
    objects["Instance314"]["Parent"] = objects["Instance313"];
    objects["Instance314"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance314"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance314"]["ZIndex"] = 1;
    objects["Instance314"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance314"]["Size"] = UDim2.new(1, 0, 0, 50);
    objects["Instance314"]["Draggable"] = false;
    objects["Instance314"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance314"]["ClipsDescendants"] = false;
    objects["Instance314"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance314"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance314"]["BackgroundTransparency"] = 1;
    objects["Instance314"]["BorderSizePixel"] = 0;
    objects["Instance314"]["Rotation"] = 0;
    objects["Instance314"]["Transparency"] = 1;
    objects["Instance314"]["Name"] = "ExporterHeader";
    objects["Instance314"]["SelectionOrder"] = 0;
    objects["Instance314"]["Visible"] = true;
    objects["Instance314"]["Selectable"] = false;
    objects["Instance314"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["Instance314"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance315"] = Instance.new("TextLabel"); -- ExporterTitle
    objects["Instance315"]["Visible"] = true;
    objects["Instance315"]["FontSize"] = Enum.FontSize.Size18;
    objects["Instance315"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance315"]["Active"] = false;
    objects["Instance315"]["TextStrokeTransparency"] = 1;
    objects["Instance315"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance315"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance315"]["ZIndex"] = 1;
    objects["Instance315"]["BorderSizePixel"] = 0;
    objects["Instance315"]["Draggable"] = false;
    objects["Instance315"]["RichText"] = false;
    objects["Instance315"]["Transparency"] = 1;
    objects["Instance315"]["SelectionOrder"] = 0;
    objects["Instance315"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance315"]["TextScaled"] = false;
    objects["Instance315"]["TextWrap"] = false;
    objects["Instance315"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["Instance315"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance315"]["Parent"] = objects["Instance314"];
    objects["Instance315"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance315"]["TextSize"] = 18;
    objects["Instance315"]["Position"] = UDim2.new(0.02, 0, 0.5, 0);
    objects["Instance315"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance315"]["Size"] = UDim2.new(0.4, 0, 0.8, 0);
    objects["Instance315"]["BackgroundTransparency"] = 1;
    objects["Instance315"]["LineHeight"] = 1;
    ...
    objects["Instance315"]["Text"] = "Script Exporter";
    objects["Instance315"]["LayoutOrder"] = 0;
    objects["Instance315"]["TextWrapped"] = false;
    objects["Instance315"]["Rotation"] = 0;
    objects["Instance315"]["TextTransparency"] = 0;
    objects["Instance315"]["Name"] = "ExporterTitle";
    objects["Instance315"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["Instance315"]["ClipsDescendants"] = false;
    objects["Instance315"]["MaxVisibleGraphemes"] = -1;
    objects["Instance315"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance315"]["Selectable"] = false;

    objects["Instance316"] = Instance.new("TextButton"); -- ScanAllButton
    objects["Instance316"]["Visible"] = true;
    objects["Instance316"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance316"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance316"]["Active"] = true;
    objects["Instance316"]["TextStrokeTransparency"] = 1;
    objects["Instance316"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance316"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance316"]["ZIndex"] = 1;
    objects["Instance316"]["BorderSizePixel"] = 0;
    objects["Instance316"]["Draggable"] = false;
    objects["Instance316"]["RichText"] = false;
    objects["Instance316"]["Modal"] = false;
    objects["Instance316"]["AutoButtonColor"] = true;
    objects["Instance316"]["Transparency"] = 0.8999999761581421;
    objects["Instance316"]["SelectionOrder"] = 0;
    objects["Instance316"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance316"]["TextScaled"] = true;
    objects["Instance316"]["TextWrap"] = true;
    objects["Instance316"]["FontFace"] = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance316"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance316"]["Parent"] = objects["Instance314"];
    objects["Instance316"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["Instance316"]["Style"] = Enum.ButtonStyle.Custom;
    objects["Instance316"]["Position"] = UDim2.new(0.98, 0, 0.5, 0);
    objects["Instance316"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);
    objects["Instance316"]["Selected"] = false;
    objects["Instance316"]["TextSize"] = 14;
    objects["Instance316"]["Size"] = UDim2.new(0, 120, 0, 36);
    objects["Instance316"]["BackgroundTransparency"] = 0;
    objects["Instance316"]["TextWrapped"] = true;
    objects["Instance316"]["ClipsDescendants"] = false;
    objects["Instance316"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance316"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance316"]["Text"] = "Scan All Scripts";
    objects["Instance316"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance316"]["LayoutOrder"] = 0;
    objects["Instance316"]["Rotation"] = 0;
    objects["Instance316"]["LineHeight"] = 1;
    objects["Instance316"]["Name"] = "ScanAllButton";
    objects["Instance316"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance316"]["Selectable"] = true;
    objects["Instance316"]["MaxVisibleGraphemes"] = -1;
    objects["Instance316"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance316"]["TextTransparency"] = 0;

    objects["Instance317"] = Instance.new("UICorner"); -- ScanAllCorner
    objects["Instance317"]["Parent"] = objects["Instance316"];
    objects["Instance317"]["Name"] = "UICorner";
    objects["Instance317"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance318"] = Instance.new("Frame"); -- ExporterFilters
    objects["Instance318"]["LayoutOrder"] = 0;
    objects["Instance318"]["Active"] = false;
    objects["Instance318"]["Parent"] = objects["Instance313"];
    objects["Instance318"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance318"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance318"]["ZIndex"] = 1;
    objects["Instance318"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance318"]["Size"] = UDim2.new(1, 0, 0, 44);
    objects["Instance318"]["Draggable"] = false;
    objects["Instance318"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance318"]["ClipsDescendants"] = false;
    objects["Instance318"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance318"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance318"]["BackgroundTransparency"] = 1;
    objects["Instance318"]["BorderSizePixel"] = 0;
    objects["Instance318"]["Rotation"] = 0;
    objects["Instance318"]["Transparency"] = 1;
    objects["Instance318"]["Name"] = "ExporterFilters";
    objects["Instance318"]["SelectionOrder"] = 0;
    objects["Instance318"]["Visible"] = true;
    objects["Instance318"]["Selectable"] = false;
    objects["Instance318"]["Position"] = UDim2.new(0, 0, 0, 50);
    objects["Instance318"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance319"] = Instance.new("Frame"); -- FilterLocalScript
    objects["Instance319"]["LayoutOrder"] = 0;
    objects["Instance319"]["Active"] = false;
    objects["Instance319"]["Parent"] = objects["Instance318"];
    objects["Instance319"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance319"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance319"]["ZIndex"] = 1;
    objects["Instance319"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance319"]["Size"] = UDim2.new(0, 100, 0, 32);
    objects["Instance319"]["Draggable"] = false;
    objects["Instance319"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance319"]["ClipsDescendants"] = false;
    objects["Instance319"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance319"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance319"]["BackgroundTransparency"] = 0.9;
    objects["Instance319"]["BorderSizePixel"] = 0;
    objects["Instance319"]["Rotation"] = 0;
    objects["Instance319"]["Transparency"] = 0;
    objects["Instance319"]["Name"] = "FilterLocalScript";
    objects["Instance319"]["SelectionOrder"] = 0;
    objects["Instance319"]["Visible"] = true;
    objects["Instance319"]["Selectable"] = false;
    objects["Instance319"]["Position"] = UDim2.new(0.01, 0, 0.5, 0);
    objects["Instance319"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);

    objects["Instance320"] = Instance.new("UICorner"); -- FilterLSCorner
    objects["Instance320"]["Parent"] = objects["Instance319"];
    objects["Instance320"]["Name"] = "UICorner";
    objects["Instance320"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance321"] = Instance.new("TextLabel"); -- FilterLSText
    objects["Instance321"]["Visible"] = true;
    objects["Instance321"]["FontSize"] = Enum.FontSize.Size12;
    objects["Instance321"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance321"]["Active"] = false;
    objects["Instance321"]["TextStrokeTransparency"] = 1;
    objects["Instance321"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance321"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance321"]["ZIndex"] = 1;
    objects["Instance321"]["BorderSizePixel"] = 0;
    objects["Instance321"]["Draggable"] = false;
    objects["Instance321"]["RichText"] = false;
    objects["Instance321"]["Transparency"] = 1;
    objects["Instance321"]["SelectionOrder"] = 0;
    objects["Instance321"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance321"]["TextScaled"] = false;
    objects["Instance321"]["TextWrap"] = false;
    objects["Instance321"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance321"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance321"]["Parent"] = objects["Instance319"];
    objects["Instance321"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance321"]["TextSize"] = 12;
    objects["Instance321"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance321"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance321"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["Instance321"]["BackgroundTransparency"] = 1;
    objects["Instance321"]["LineHeight"] = 1;
    objects["Instance321"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance321"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance321"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance321"]["Text"] = "LocalScripts";
    objects["Instance321"]["LayoutOrder"] = 0;
    objects["Instance321"]["TextWrapped"] = false;
    objects["Instance321"]["Rotation"] = 0;
    objects["Instance321"]["TextTransparency"] = 0;
    objects["Instance321"]["Name"] = "FilterLSText";
    objects["Instance321"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance321"]["ClipsDescendants"] = false;
    objects["Instance321"]["MaxVisibleGraphemes"] = -1;
    objects["Instance321"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance321"]["Selectable"] = false;

    objects["Instance322"] = Instance.new("Frame"); -- FilterModuleScript
    objects["Instance322"]["LayoutOrder"] = 0;
    objects["Instance322"]["Active"] = false;
    objects["Instance322"]["Parent"] = objects["Instance318"];
    objects["Instance322"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance322"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance322"]["ZIndex"] = 1;
    objects["Instance322"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance322"]["Size"] = UDim2.new(0, 100, 0, 32);
    objects["Instance322"]["Draggable"] = false;
    objects["Instance322"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance322"]["ClipsDescendants"] = false;
    objects["Instance322"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance322"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance322"]["BackgroundTransparency"] = 0.9;
    objects["Instance322"]["BorderSizePixel"] = 0;
    objects["Instance322"]["Rotation"] = 0;
    objects["Instance322"]["Transparency"] = 0;
    objects["Instance322"]["Name"] = "FilterModuleScript";
    objects["Instance322"]["SelectionOrder"] = 0;
    objects["Instance322"]["Visible"] = true;
    objects["Instance322"]["Selectable"] = false;
    objects["Instance322"]["Position"] = UDim2.new(0.01, 110, 0.5, 0);
    objects["Instance322"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);

    objects["Instance323"] = Instance.new("UICorner"); -- FilterMSCorner
    objects["Instance323"]["Parent"] = objects["Instance322"];
    objects["Instance323"]["Name"] = "UICorner";
    objects["Instance323"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance324"] = Instance.new("TextLabel"); -- FilterMSText
    objects["Instance324"]["Visible"] = true;
    objects["Instance324"]["FontSize"] = Enum.FontSize.Size12;
    objects["Instance324"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance324"]["Active"] = false;
    objects["Instance324"]["TextStrokeTransparency"] = 1;
    objects["Instance324"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance324"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance324"]["ZIndex"] = 1;
    objects["Instance324"]["BorderSizePixel"] = 0;
    objects["Instance324"]["Draggable"] = false;
    objects["Instance324"]["RichText"] = false;
    objects["Instance324"]["Transparency"] = 1;
    objects["Instance324"]["SelectionOrder"] = 0;
    objects["Instance324"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance324"]["TextScaled"] = false;
    objects["Instance324"]["TextWrap"] = false;
    objects["Instance324"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance324"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance324"]["Parent"] = objects["Instance322"];
    objects["Instance324"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance324"]["TextSize"] = 12;
    objects["Instance324"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance324"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance324"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["Instance324"]["BackgroundTransparency"] = 1;
    objects["Instance324"]["LineHeight"] = 1;
    objects["Instance324"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance324"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance324"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance324"]["Text"] = "ModuleScripts";
    objects["Instance324"]["LayoutOrder"] = 0;
    objects["Instance324"]["TextWrapped"] = false;
    objects["Instance324"]["Rotation"] = 0;
    objects["Instance324"]["TextTransparency"] = 0;
    objects["Instance324"]["Name"] = "FilterMSText";
    objects["Instance324"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance324"]["ClipsDescendants"] = false;
    objects["Instance324"]["MaxVisibleGraphemes"] = -1;
    objects["Instance324"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance324"]["Selectable"] = false;

    objects["Instance325"] = Instance.new("Frame"); -- FilterScript
    objects["Instance325"]["LayoutOrder"] = 0;
    objects["Instance325"]["Active"] = false;
    objects["Instance325"]["Parent"] = objects["Instance318"];
    objects["Instance325"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance325"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance325"]["ZIndex"] = 1;
    objects["Instance325"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance325"]["Size"] = UDim2.new(0, 80, 0, 32);
    objects["Instance325"]["Draggable"] = false;
    objects["Instance325"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance325"]["ClipsDescendants"] = false;
    objects["Instance325"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance325"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance325"]["BackgroundTransparency"] = 0.9;
    objects["Instance325"]["BorderSizePixel"] = 0;
    objects["Instance325"]["Rotation"] = 0;
    objects["Instance325"]["Transparency"] = 0;
    objects["Instance325"]["Name"] = "FilterScript";
    objects["Instance325"]["SelectionOrder"] = 0;
    objects["Instance325"]["Visible"] = true;
    objects["Instance325"]["Selectable"] = false;
    objects["Instance325"]["Position"] = UDim2.new(0.01, 220, 0.5, 0);
    objects["Instance325"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);

    objects["Instance326"] = Instance.new("UICorner"); -- FilterScrCorner
    objects["Instance326"]["Parent"] = objects["Instance325"];
    objects["Instance326"]["Name"] = "UICorner";
    objects["Instance326"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance327"] = Instance.new("TextLabel"); -- FilterScrText
    objects["Instance327"]["Visible"] = true;
    objects["Instance327"]["FontSize"] = Enum.FontSize.Size12;
    objects["Instance327"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance327"]["Active"] = false;
    objects["Instance327"]["TextStrokeTransparency"] = 1;
    objects["Instance327"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance327"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance327"]["ZIndex"] = 1;
    objects["Instance327"]["BorderSizePixel"] = 0;
    objects["Instance327"]["Draggable"] = false;
    objects["Instance327"]["RichText"] = false;
    objects["Instance327"]["Transparency"] = 1;
    objects["Instance327"]["SelectionOrder"] = 0;
    objects["Instance327"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance327"]["TextScaled"] = false;
    objects["Instance327"]["TextWrap"] = false;
    objects["Instance327"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance327"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance327"]["Parent"] = objects["Instance325"];
    objects["Instance327"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance327"]["TextSize"] = 12;
    objects["Instance327"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance327"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance327"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["Instance327"]["BackgroundTransparency"] = 1;
    objects["Instance327"]["LineHeight"] = 1;
    objects["Instance327"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance327"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance327"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance327"]["Text"] = "Scripts";
    objects["Instance327"]["LayoutOrder"] = 0;
    objects["Instance327"]["TextWrapped"] = false;
    objects["Instance327"]["Rotation"] = 0;
    objects["Instance327"]["TextTransparency"] = 0;
    objects["Instance327"]["Name"] = "FilterScrText";
    objects["Instance327"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance327"]["ClipsDescendants"] = false;
    objects["Instance327"]["MaxVisibleGraphemes"] = -1;
    objects["Instance327"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance327"]["Selectable"] = false;

    objects["Instance328"] = Instance.new("Frame"); -- SearchField
    objects["Instance328"]["LayoutOrder"] = 0;
    objects["Instance328"]["Active"] = true;
    objects["Instance328"]["Parent"] = objects["Instance318"];
    objects["Instance328"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance328"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance328"]["ZIndex"] = 1;
    objects["Instance328"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance328"]["Size"] = UDim2.new(0.4, 0, 0.7, 0);
    objects["Instance328"]["Draggable"] = false;
    objects["Instance328"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance328"]["ClipsDescendants"] = true;
    objects["Instance328"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance328"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance328"]["BackgroundTransparency"] = 0.85;
    objects["Instance328"]["BorderSizePixel"] = 0;
    objects["Instance328"]["Rotation"] = 0;
    objects["Instance328"]["Transparency"] = 0;
    objects["Instance328"]["Name"] = "SearchField";
    objects["Instance328"]["SelectionOrder"] = 0;
    objects["Instance328"]["Visible"] = true;
    objects["Instance328"]["Selectable"] = true;
    objects["Instance328"]["Position"] = UDim2.new(0.98, -200, 0.5, 0);
    objects["Instance328"]["BackgroundColor3"] = Color3.new(0.15, 0.15, 0.15);

    objects["Instance329"] = Instance.new("UICorner"); -- SearchCorner
    objects["Instance329"]["Parent"] = objects["Instance328"];
    objects["Instance329"]["Name"] = "UICorner";
    objects["Instance329"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance330"] = Instance.new("TextBox"); -- SearchBox
    objects["Instance330"]["LayoutOrder"] = 0;
    objects["Instance330"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance330"]["LineHeight"] = 1;
    objects["Instance330"]["Active"] = true;
    objects["Instance330"]["TextStrokeTransparency"] = 1;
    objects["Instance330"]["SelectionStart"] = -1;
    objects["Instance330"]["PlaceholderColor3"] = Color3.new(0.5, 0.5, 0.5);
    objects["Instance330"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance330"]["ZIndex"] = 1;
    objects["Instance330"]["BorderSizePixel"] = 0;
    objects["Instance330"]["TextEditable"] = true;
    objects["Instance330"]["Draggable"] = false;
    objects["Instance330"]["RichText"] = false;
    objects["Instance330"]["Transparency"] = 1;
    objects["Instance330"]["SelectionOrder"] = 0;
    objects["Instance330"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance330"]["TextScaled"] = false;
    objects["Instance330"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance330"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance330"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance330"]["Parent"] = objects["Instance328"];
    objects["Instance330"]["TextWrapped"] = false;
    objects["Instance330"]["MaxVisibleGraphemes"] = -1;
    objects["Instance330"]["Name"] = "SearchBox";
    objects["Instance330"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance330"]["TextTransparency"] = 0;
    objects["Instance330"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance330"]["CursorPosition"] = 1;
    objects["Instance330"]["ClipsDescendants"] = false;
    objects["Instance330"]["PlaceholderText"] = "Search scripts...";
    objects["Instance330"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance330"]["Size"] = UDim2.new(1, -10, 1, 0);
    objects["Instance330"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance330"]["Selectable"] = true;
    objects["Instance330"]["ShowNativeInput"] = true;
    objects["Instance330"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance330"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance330"]["Text"] = "";
    objects["Instance330"]["TextSize"] = 14;
    objects["Instance330"]["Visible"] = true;
    objects["Instance330"]["Rotation"] = 0;
    objects["Instance330"]["MultiLine"] = false;
    objects["Instance330"]["BackgroundTransparency"] = 1;
    objects["Instance330"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["Instance330"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance330"]["ClearTextOnFocus"] = false;
    objects["Instance330"]["Position"] = UDim2.new(0, 10, 0.5, 0);
    objects["Instance330"]["TextWrap"] = false;

    objects["Instance331"] = Instance.new("Frame"); -- ExporterProgress
    objects["Instance331"]["LayoutOrder"] = 0;
    objects["Instance331"]["Active"] = false;
    objects["Instance331"]["Parent"] = objects["Instance313"];
    objects["Instance331"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance331"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance331"]["ZIndex"] = 1;
    objects["Instance331"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance331"]["Size"] = UDim2.new(1, 0, 0, 30);
    objects["Instance331"]["Draggable"] = false;
    objects["Instance331"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance331"]["ClipsDescendants"] = false;
    objects["Instance331"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance331"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance331"]["BackgroundTransparency"] = 1;
    objects["Instance331"]["BorderSizePixel"] = 0;
    objects["Instance331"]["Rotation"] = 0;
    objects["Instance331"]["Transparency"] = 1;
    objects["Instance331"]["Name"] = "ExporterProgress";
    objects["Instance331"]["SelectionOrder"] = 0;
    objects["Instance331"]["Visible"] = false;
    objects["Instance331"]["Selectable"] = false;
    objects["Instance331"]["Position"] = UDim2.new(0, 0, 0, 94);
    objects["Instance331"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance332"] = Instance.new("Frame"); -- ProgressBar
    objects["Instance332"]["LayoutOrder"] = 0;
    objects["Instance332"]["Active"] = false;
    objects["Instance332"]["Parent"] = objects["Instance331"];
    objects["Instance332"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance332"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance332"]["ZIndex"] = 1;
    objects["Instance332"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance332"]["Size"] = UDim2.new(0.9, 0, 0.6, 0);
    objects["Instance332"]["Draggable"] = false;
    objects["Instance332"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance332"]["ClipsDescendants"] = false;
    objects["Instance332"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance332"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance332"]["BackgroundTransparency"] = 0.9;
    objects["Instance332"]["BorderSizePixel"] = 0;
    objects["Instance332"]["Rotation"] = 0;
    objects["Instance332"]["Transparency"] = 0;
    objects["Instance332"]["Name"] = "ProgressBar";
    objects["Instance332"]["SelectionOrder"] = 0;
    objects["Instance332"]["Visible"] = true;
    objects["Instance332"]["Selectable"] = false;
    objects["Instance332"]["Position"] = UDim2.new(0.05, 0, 0.5, 0);
    objects["Instance332"]["BackgroundColor3"] = Color3.new(0.2, 0.2, 0.2);

    objects["Instance333"] = Instance.new("UICorner"); -- ProgressCorner
    objects["Instance333"]["Parent"] = objects["Instance332"];
    objects["Instance333"]["Name"] = "UICorner";
    objects["Instance333"]["CornerRadius"] = UDim.new(0.5, 0);

    objects["Instance334"] = Instance.new("Frame"); -- ProgressFill
    objects["Instance334"]["LayoutOrder"] = 0;
    objects["Instance334"]["Active"] = false;
    objects["Instance334"]["Parent"] = objects["Instance332"];
    objects["Instance334"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance334"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance334"]["ZIndex"] = 2;
    objects["Instance334"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance334"]["Size"] = UDim2.new(0, 0, 1, 0);
    objects["Instance334"]["Draggable"] = false;
    objects["Instance334"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance334"]["ClipsDescendants"] = false;
    objects["Instance334"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance334"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance334"]["BackgroundTransparency"] = 0;
    objects["Instance334"]["BorderSizePixel"] = 0;
    objects["Instance334"]["Rotation"] = 0;
    objects["Instance334"]["Transparency"] = 0;
    objects["Instance334"]["Name"] = "ProgressFill";
    objects["Instance334"]["SelectionOrder"] = 0;
    objects["Instance334"]["Visible"] = true;
    objects["Instance334"]["Selectable"] = false;
    objects["Instance334"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["Instance334"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);

    objects["Instance335"] = Instance.new("UICorner"); -- ProgressFillCorner
    objects["Instance335"]["Parent"] = objects["Instance334"];
    objects["Instance335"]["Name"] = "UICorner";
    objects["Instance335"]["CornerRadius"] = UDim.new(0.5, 0);

    objects["Instance336"] = Instance.new("TextLabel"); -- ProgressText
    objects["Instance336"]["Visible"] = true;
    objects["Instance336"]["FontSize"] = Enum.FontSize.Size12;
    objects["Instance336"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance336"]["Active"] = false;
    objects["Instance336"]["TextStrokeTransparency"] = 1;
    objects["Instance336"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance336"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance336"]["ZIndex"] = 1;
    objects["Instance336"]["BorderSizePixel"] = 0;
    objects["Instance336"]["Draggable"] = false;
    objects["Instance336"]["RichText"] = false;
    objects["Instance336"]["Transparency"] = 1;
    objects["Instance336"]["SelectionOrder"] = 0;
    objects["Instance336"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance336"]["TextScaled"] = false;
    objects["Instance336"]["TextWrap"] = false;
    objects["Instance336"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance336"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance336"]["Parent"] = objects["Instance331"];
    objects["Instance336"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance336"]["TextSize"] = 12;
    objects["Instance336"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance336"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance336"]["Size"] = UDim2.new(0.9, 0, 1, 0);
    objects["Instance336"]["BackgroundTransparency"] = 1;
    objects["Instance336"]["LineHeight"] = 1;
    objects["Instance336"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance336"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance336"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance336"]["Text"] = "0 / 0 scripts";
    objects["Instance336"]["LayoutOrder"] = 0;
    objects["Instance336"]["TextWrapped"] = false;
    objects["Instance336"]["Rotation"] = 0;
    objects["Instance336"]["TextTransparency"] = 0;
    objects["Instance336"]["Name"] = "ProgressText";
    objects["Instance336"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance336"]["ClipsDescendants"] = false;
    objects["Instance336"]["MaxVisibleGraphemes"] = -1;
    objects["Instance336"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance336"]["Selectable"] = false;

    objects["Instance337"] = Instance.new("ScrollingFrame"); -- ScriptsList
    objects["Instance337"]["Visible"] = true;
    objects["Instance337"]["Active"] = true;
    objects["Instance337"]["ScrollingDirection"] = Enum.ScrollingDirection.Y;
    objects["Instance337"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance337"]["ZIndex"] = 1;
    objects["Instance337"]["BorderSizePixel"] = 0;
    objects["Instance337"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
    objects["Instance337"]["Draggable"] = false;
    objects["Instance337"]["MidImage"] = "rbxasset://textures/ui/Scroll/scroll-middle.png";
    objects["Instance337"]["CanvasPosition"] = Vector2.new(0, 0);
    objects["Instance337"]["VerticalScrollBarInset"] = Enum.ScrollBarInset.None;
    objects["Instance337"]["Transparency"] = 1;
    objects["Instance337"]["TopImage"] = "rbxasset://textures/ui/Scroll/scroll-top.png";
    objects["Instance337"]["SelectionOrder"] = 0;
    objects["Instance337"]["HorizontalScrollBarInset"] = Enum.ScrollBarInset.None;
    objects["Instance337"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance337"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;
    objects["Instance337"]["VerticalScrollBarPosition"] = Enum.VerticalScrollBarPosition.Right;
    objects["Instance337"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance337"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance337"]["Size"] = UDim2.new(1, 0, 0.5, 0);
    objects["Instance337"]["ScrollBarImageColor3"] = Color3.new(0.4, 0.4, 0.4);
    objects["Instance337"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance337"]["Selectable"] = true;
    objects["Instance337"]["ClipsDescendants"] = true;
    objects["Instance337"]["ScrollBarImageTransparency"] = 0.5;
    objects["Instance337"]["ScrollBarThickness"] = 6;
    objects["Instance337"]["Parent"] = objects["Instance313"];
    objects["Instance337"]["BackgroundTransparency"] = 1;
    objects["Instance337"]["Rotation"] = 0;
    objects["Instance337"]["LayoutOrder"] = 0;
    objects["Instance337"]["Name"] = "ScriptsList";
    objects["Instance337"]["Position"] = UDim2.new(0, 0, 0.15, 0);
    objects["Instance337"]["ScrollingEnabled"] = true;
    objects["Instance337"]["BottomImage"] = "rbxasset://textures/ui/Scroll/scroll-bottom.png";
    objects["Instance337"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance337"]["ElasticBehavior"] = Enum.ElasticBehavior.WhenScrollable;

    objects["Instance338"] = Instance.new("UIListLayout"); -- ScriptsListLayout
    objects["Instance338"]["FillDirection"] = Enum.FillDirection.Vertical;
    objects["Instance338"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Left;
    objects["Instance338"]["VerticalFlex"] = Enum.UIFlexAlignment.None;
    objects["Instance338"]["Parent"] = objects["Instance337"];
    objects["Instance338"]["VerticalAlignment"] = Enum.VerticalAlignment.Top;
    objects["Instance338"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
    objects["Instance338"]["Name"] = "UIListLayout";
    objects["Instance338"]["Padding"] = UDim.new(0, 2);
    objects["Instance338"]["ItemLineAlignment"] = Enum.ItemLineAlignment.Automatic;
    objects["Instance338"]["HorizontalFlex"] = Enum.UIFlexAlignment.None;

    objects["Instance339"] = Instance.new("TextButton"); -- ScriptItemTemplate
    objects["Instance339"]["Visible"] = false;
    objects["Instance339"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance339"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance339"]["Active"] = false;
    objects["Instance339"]["TextStrokeTransparency"] = 1;
    objects["Instance339"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance339"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance339"]["ZIndex"] = 1;
    objects["Instance339"]["BorderSizePixel"] = 0;
    objects["Instance339"]["Draggable"] = false;
    objects["Instance339"]["RichText"] = false;
    objects["Instance339"]["Modal"] = false;
    objects["Instance339"]["AutoButtonColor"] = true;
    objects["Instance339"]["Transparency"] = 1;
    objects["Instance339"]["SelectionOrder"] = 0;
    objects["Instance339"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance339"]["TextScaled"] = false;
    objects["Instance339"]["TextWrap"] = false;
    objects["Instance339"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance339"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance339"]["Parent"] = objects["Instance337"];
    objects["Instance339"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["Instance339"]["Style"] = Enum.ButtonStyle.Custom;
    objects["Instance339"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["Instance339"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance339"]["Selected"] = false;
    objects["Instance339"]["TextSize"] = 14;
    objects["Instance339"]["Size"] = UDim2.new(1, 0, 0, 50);
    objects["Instance339"]["BackgroundTransparency"] = 0.95;
    objects["Instance339"]["TextWrapped"] = false;
    objects["Instance339"]["ClipsDescendants"] = false;
    objects["Instance339"]["TextColor3"] = Color3.new(0, 0, 0);
    objects["Instance339"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance339"]["Text"] = "";
    objects["Instance339"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance339"]["LayoutOrder"] = 0;
    objects["Instance339"]["Rotation"] = 0;
    objects["Instance339"]["LineHeight"] = 1;
    objects["Instance339"]["Name"] = "ScriptItemTemplate";
    objects["Instance339"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance339"]["Selectable"] = false;
    objects["Instance339"]["MaxVisibleGraphemes"] = -1;
    objects["Instance339"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance339"]["TextTransparency"] = 0;

    objects["Instance340"] = Instance.new("Frame"); -- ScriptItemContent
    objects["Instance340"]["LayoutOrder"] = 0;
    objects["Instance340"]["Active"] = false;
    objects["Instance340"]["Parent"] = objects["Instance339"];
    objects["Instance340"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["Instance340"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance340"]["ZIndex"] = 1;
    objects["Instance340"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance340"]["Size"] = UDim2.new(1, -4, 1, -4);
    objects["Instance340"]["Draggable"] = false;
    objects["Instance340"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance340"]["ClipsDescendants"] = false;
    objects["Instance340"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance340"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance340"]["BackgroundTransparency"] = 0.95;
    objects["Instance340"]["BorderSizePixel"] = 0;
    objects["Instance340"]["Rotation"] = 0;
    objects["Instance340"]["Transparency"] = 0;
    objects["Instance340"]["Name"] = "ScriptItemContent";
    objects["Instance340"]["SelectionOrder"] = 0;
    objects["Instance340"]["Visible"] = true;
    objects["Instance340"]["Selectable"] = false;
    objects["Instance340"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["Instance340"]["BackgroundColor3"] = Color3.new(0.15, 0.15, 0.15);

    objects["Instance341"] = Instance.new("UICorner"); -- ScriptItemCorner
    objects["Instance341"]["Parent"] = objects["Instance340"];
    objects["Instance341"]["Name"] = "UICorner";
    objects["Instance341"]["CornerRadius"] = UDim.new(0.0500000007, 0);

    objects["Instance342"] = Instance.new("TextLabel"); -- ScriptItemName
    objects["Instance342"]["Visible"] = true;
    objects["Instance342"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance342"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance342"]["Active"] = false;
    objects["Instance342"]["TextStrokeTransparency"] = 1;
    objects["Instance342"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance342"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance342"]["ZIndex"] = 1;
    objects["Instance342"]["BorderSizePixel"] = 0;
    objects["Instance342"]["Draggable"] = false;
    objects["Instance342"]["RichText"] = false;
    objects["Instance342"]["Transparency"] = 1;
    objects["Instance342"]["SelectionOrder"] = 0;
    objects["Instance342"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance342"]["TextScaled"] = false;
    objects["Instance342"]["TextWrap"] = true;
    objects["Instance342"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["Instance342"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance342"]["Parent"] = objects["Instance340"];
    objects["Instance342"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance342"]["TextSize"] = 14;
    objects["Instance342"]["Position"] = UDim2.new(0.02, 0, 0.3, 0);
    objects["Instance342"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance342"]["Size"] = UDim2.new(0.6, 0, 0.5, 0);
    objects["Instance342"]["BackgroundTransparency"] = 1;
    objects["Instance342"]["LineHeight"] = 1;
    objects["Instance342"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance342"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance342"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance342"]["Text"] = "ScriptName";
    objects["Instance342"]["LayoutOrder"] = 0;
    objects["Instance342"]["TextWrapped"] = true;
    objects["Instance342"]["Rotation"] = 0;
    objects["Instance342"]["TextTransparency"] = 0;
    objects["Instance342"]["Name"] = "ScriptItemName";
    objects["Instance342"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["Instance342"]["ClipsDescendants"] = false;
    objects["Instance342"]["MaxVisibleGraphemes"] = -1;
    objects["Instance342"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance342"]["Selectable"] = false;

    objects["Instance343"] = Instance.new("TextLabel"); -- ScriptItemPath
    objects["Instance343"]["Visible"] = true;
    objects["Instance343"]["FontSize"] = Enum.FontSize.Size10;
    objects["Instance343"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance343"]["Active"] = false;
    objects["Instance343"]["TextStrokeTransparency"] = 1;
    objects["Instance343"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance343"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance343"]["ZIndex"] = 1;
    objects["Instance343"]["BorderSizePixel"] = 0;
    objects["Instance343"]["Draggable"] = false;
    objects["Instance343"]["RichText"] = false;
    objects["Instance343"]["Transparency"] = 1;
    objects["Instance343"]["SelectionOrder"] = 0;
    objects["Instance343"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance343"]["TextScaled"] = false;
    objects["Instance343"]["TextWrap"] = true;
    objects["Instance343"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance343"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance343"]["Parent"] = objects["Instance340"];
    objects["Instance343"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance343"]["TextSize"] = 10;
    objects["Instance343"]["Position"] = UDim2.new(0.02, 0, 0.8, 0);
    objects["Instance343"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance343"]["Size"] = UDim2.new(0.6, 0, 0.4, 0);
    objects["Instance343"]["BackgroundTransparency"] = 1;
    objects["Instance343"]["LineHeight"] = 1;
    objects["Instance343"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance343"]["TextColor3"] = Color3.new(0.5, 0.5, 0.5);
    objects["Instance343"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance343"]["Text"] = "path/to/script";
    objects["Instance343"]["LayoutOrder"] = 0;
    objects["Instance343"]["TextWrapped"] = true;
    objects["Instance343"]["Rotation"] = 0;
    objects["Instance343"]["TextTransparency"] = 0;
    objects["Instance343"]["Name"] = "ScriptItemPath";
    objects["Instance343"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["Instance343"]["ClipsDescendants"] = false;
    objects["Instance343"]["MaxVisibleGraphemes"] = -1;
    objects["Instance343"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance343"]["Selectable"] = false;

    objects["Instance344"] = Instance.new("TextLabel"); -- ScriptItemInfo
    objects["Instance344"]["Visible"] = true;
    objects["Instance344"]["FontSize"] = Enum.FontSize.Size10;
    objects["Instance344"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance344"]["Active"] = false;
    objects["Instance344"]["TextStrokeTransparency"] = 1;
    objects["Instance344"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance344"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance344"]["ZIndex"] = 1;
    objects["Instance344"]["BorderSizePixel"] = 0;
    objects["Instance344"]["Draggable"] = false;
    objects["Instance344"]["RichText"] = false;
    objects["Instance344"]["Transparency"] = 1;
    objects["Instance344"]["SelectionOrder"] = 0;
    objects["Instance344"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance344"]["TextScaled"] = false;
    objects["Instance344"]["TextWrap"] = false;
    objects["Instance344"]["FontFace"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance344"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance344"]["Parent"] = objects["Instance340"];
    objects["Instance344"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["Instance344"]["TextSize"] = 10;
    objects["Instance344"]["Position"] = UDim2.new(0.98, 0, 0.5, 0);
    objects["Instance344"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance344"]["Size"] = UDim2.new(0.35, 0, 0.9, 0);
    objects["Instance344"]["BackgroundTransparency"] = 1;
    objects["Instance344"]["LineHeight"] = 1;
    objects["Instance344"]["BackgroundColor3"] = Color3.new(1, 1, 1);
    objects["Instance344"]["TextColor3"] = Color3.new(0.6, 0.6, 0.6);
    objects["Instance344"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance344"]["Text"] = "LocalScript";
    objects["Instance344"]["LayoutOrder"] = 0;
    objects["Instance344"]["TextWrapped"] = false;
    objects["Instance344"]["Rotation"] = 0;
    objects["Instance344"]["TextTransparency"] = 0;
    objects["Instance344"]["Name"] = "ScriptItemInfo";
    objects["Instance344"]["TextXAlignment"] = Enum.TextXAlignment.Right;
    objects["Instance344"]["ClipsDescendants"] = false;
    objects["Instance344"]["MaxVisibleGraphemes"] = -1;
    objects["Instance344"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance344"]["Selectable"] = false;

    objects["Instance345"] = Instance.new("Frame"); -- ExporterActions
    objects["Instance345"]["LayoutOrder"] = 0;
    objects["Instance345"]["Active"] = false;
    objects["Instance345"]["Parent"] = objects["Instance313"];
    objects["Instance345"]["AnchorPoint"] = Vector2.new(0, 1);
    objects["Instance345"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance345"]["ZIndex"] = 1;
    objects["Instance345"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance345"]["Size"] = UDim2.new(1, 0, 0, 50);
    objects["Instance345"]["Draggable"] = false;
    objects["Instance345"]["Style"] = Enum.FrameStyle.Custom;
    objects["Instance345"]["ClipsDescendants"] = false;
    objects["Instance345"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance345"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance345"]["BackgroundTransparency"] = 1;
    objects["Instance345"]["BorderSizePixel"] = 0;
    objects["Instance345"]["Rotation"] = 0;
    objects["Instance345"]["Transparency"] = 1;
    objects["Instance345"]["Name"] = "ExporterActions";
    objects["Instance345"]["SelectionOrder"] = 0;
    objects["Instance345"]["Visible"] = true;
    objects["Instance345"]["Selectable"] = false;
    objects["Instance345"]["Position"] = UDim2.new(0, 0, 1, -50);
    objects["Instance345"]["BackgroundColor3"] = Color3.new(1, 1, 1);

    objects["Instance346"] = Instance.new("TextButton"); -- SelectAllButton
    objects["Instance346"]["Visible"] = true;
    objects["Instance346"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance346"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance346"]["Active"] = true;
    objects["Instance346"]["TextStrokeTransparency"] = 1;
    objects["Instance346"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance346"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance346"]["ZIndex"] = 1;
    objects["Instance346"]["BorderSizePixel"] = 0;
    objects["Instance346"]["Draggable"] = false;
    objects["Instance346"]["RichText"] = false;
    objects["Instance346"]["Modal"] = false;
    objects["Instance346"]["AutoButtonColor"] = true;
    objects["Instance346"]["Transparency"] = 0.8999999761581421;
    objects["Instance346"]["SelectionOrder"] = 0;
    objects["Instance346"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance346"]["TextScaled"] = true;
    objects["Instance346"]["TextWrap"] = true;
    objects["Instance346"]["FontFace"] = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance346"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance346"]["Parent"] = objects["Instance345"];
    objects["Instance346"]["AnchorPoint"] = Vector2.new(0, 0.5);
    objects["Instance346"]["Style"] = Enum.ButtonStyle.Custom;
    objects["Instance346"]["Position"] = UDim2.new(0.02, 0, 0.5, 0);
    objects["Instance346"]["BackgroundColor3"] = Color3.new(0.3, 0.3, 0.3);
    objects["Instance346"]["Selected"] = false;
    objects["Instance346"]["TextSize"] = 14;
    objects["Instance346"]["Size"] = UDim2.new(0, 100, 0, 36);
    objects["Instance346"]["BackgroundTransparency"] = 0;
    objects["Instance346"]["TextWrapped"] = true;
    objects["Instance346"]["ClipsDescendants"] = false;
    objects["Instance346"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance346"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance346"]["Text"] = "Select All";
    objects["Instance346"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance346"]["LayoutOrder"] = 0;
    objects["Instance346"]["Rotation"] = 0;
    objects["Instance346"]["LineHeight"] = 1;
    objects["Instance346"]["Name"] = "SelectAllButton";
    objects["Instance346"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance346"]["Selectable"] = true;
    objects["Instance346"]["MaxVisibleGraphemes"] = -1;
    objects["Instance346"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance346"]["TextTransparency"] = 0;

    objects["Instance347"] = Instance.new("UICorner"); -- SelectAllCorner
    objects["Instance347"]["Parent"] = objects["Instance346"];
    objects["Instance347"]["Name"] = "UICorner";
    objects["Instance347"]["CornerRadius"] = UDim.new(0.100000001, 0);

    objects["Instance348"] = Instance.new("TextButton"); -- ExportSelectedButton
    objects["Instance348"]["Visible"] = true;
    objects["Instance348"]["FontSize"] = Enum.FontSize.Size14;
    objects["Instance348"]["TextDirection"] = Enum.TextDirection.Auto;
    objects["Instance348"]["Active"] = true;
    objects["Instance348"]["TextStrokeTransparency"] = 1;
    objects["Instance348"]["TextTruncate"] = Enum.TextTruncate.None;
    objects["Instance348"]["SizeConstraint"] = Enum.SizeConstraint.RelativeXY;
    objects["Instance348"]["ZIndex"] = 1;
    objects["Instance348"]["BorderSizePixel"] = 0;
    objects["Instance348"]["Draggable"] = false;
    objects["Instance348"]["RichText"] = false;
    objects["Instance348"]["Modal"] = false;
    objects["Instance348"]["AutoButtonColor"] = true;
    objects["Instance348"]["Transparency"] = 0.8999999761581421;
    objects["Instance348"]["SelectionOrder"] = 0;
    objects["Instance348"]["TextYAlignment"] = Enum.TextYAlignment.Center;
    objects["Instance348"]["TextScaled"] = true;
    objects["Instance348"]["TextWrap"] = true;
    objects["Instance348"]["FontFace"] = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["Instance348"]["BorderMode"] = Enum.BorderMode.Outline;
    objects["Instance348"]["Parent"] = objects["Instance345"];
    objects["Instance348"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["Instance348"]["Style"] = Enum.ButtonStyle.Custom;
    objects["Instance348"]["Position"] = UDim2.new(0.98, 0, 0.5, 0);
    objects["Instance348"]["BackgroundColor3"] = Color3.new(0.160784, 0.505882, 0.333333);
    objects["Instance348"]["Selected"] = false;
    objects["Instance348"]["TextSize"] = 14;
    objects["Instance348"]["Size"] = UDim2.new(0, 140, 0, 36);
    objects["Instance348"]["BackgroundTransparency"] = 0;
    objects["Instance348"]["TextWrapped"] = true;
    objects["Instance348"]["ClipsDescendants"] = false;
    objects["Instance348"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["Instance348"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance348"]["Text"] = "Export Selected (0)";
    objects["Instance348"]["AutomaticSize"] = Enum.AutomaticSize.None;
    objects["Instance348"]["LayoutOrder"] = 0;
    objects["Instance348"]["Rotation"] = 0;
    objects["Instance348"]["LineHeight"] = 1;
    objects["Instance348"]["Name"] = "ExportSelectedButton";
    objects["Instance348"]["TextXAlignment"] = Enum.TextXAlignment.Center;
    objects["Instance348"]["Selectable"] = true;
    objects["Instance348"]["MaxVisibleGraphemes"] = -1;
    objects["Instance348"]["TextStrokeColor3"] = Color3.new(0, 0, 0);
    objects["Instance348"]["TextTransparency"] = 0;

    objects["Instance349"] = Instance.new("UICorner"); -- ExportCorner
    objects["Instance349"]["Parent"] = objects["Instance348"];
    objects["Instance349"]["Name"] = "UICorner";
    objects["Instance349"]["CornerRadius"] = UDim.new(0.100000001, 0);
end;
...
return function(shared, page)
    ...
    modules[objects["Instance350"]] = function()
        local script = objects["Instance350"];
return function(shared, page)
    local cons = shared.Connections
        ...
        for _, v in pairs(container:GetChildren()) do
            if v:IsA("LocalScript") or v:IsA("ModuleScript") or v:IsA("Script") then
                ...
                table.insert(allScripts, {
                    instance = v,
                    name = v.Name,
                    path = getScriptPath(v),
                    type = v.ClassName,
                    source = v:IsA("LocalScript") and v.Source or (v:IsA("ModuleScript") and v.Source or (v:IsA("Script") and v.Source or ""))
                })
            end
            if v:IsA("Instance") then
                count = count + scanScripts(v)
            end
        end
        return count
    end
    ...
    local function decompileScript(scriptObj)
        ...
        return success and result or "-- Decompile failed: " .. tostring(result)
    end
    
    local function updateScriptsList()
        local searchText = page.SearchBox.SearchBox.Text:lower()
        
        for _, child in pairs(page.ScriptsList:GetChildren()) do
            if child:IsA("TextButton") and child.Name ~= "ScriptItemTemplate" then
                child:Destroy()
            end
        end
        ...
        for _, scriptData in ipairs(allScripts) do
            if not filters[scriptData.type] then continue end
            if searchText ~= "" and not scriptData.name:lower():find(searchText) and not scriptData.path:lower():find(searchText) then
                continue
            end
            
            count = count + 1
            local item = page.ScriptsList.ScriptItemTemplate:Clone()
            item.Name = scriptData.name
            item.Visible = true
            item.ScriptItemName.Text = scriptData.name
            item.ScriptItemPath.Text = scriptData.path
            
            local lines = countLines(scriptData.source)
            local size = #scriptData.source
            item.ScriptItemInfo.Text = scriptData.type .. " | " .. lines .. " lines | " .. math.floor(size / 1024 * 10) / 10 .. "KB"
            
            local isSelected = false
            for _, sel in ipairs(selectedScripts) do
                if sel.path == scriptData.path then
                    isSelected = true
                    break
                end
            end
            ...
            if isSelected then
                item.ScriptItemContent.BackgroundColor3 = Color3.new(0.2, 0.4, 0.3)
            else
                item.ScriptItemContent.BackgroundColor3 = Color3.new(0.15, 0.15, 0.15)
            end
            
            item.MouseButton1Click:Connect(function()
                local found = false
                for i, sel in ipairs(selectedScripts) do
                    if sel.path == scriptData.path then
                ...
                page.ExporterActions.ExportSelectedButton.Text = "Export Selected (" .. #selectedScripts .. ")"
                updateScriptsList()
            end)
            
            item.Parent = page.ScriptsList
        end
    end
    
    local function updateProgress(current, total, text)
        page.ExporterProgress.Visible = true
        local percent = total > 0 and current / total or 0
        page.ExporterProgress.ProgressBar.ProgressFill.Size = UDim2.new(percent, 0, 1, 0)
        page.ExporterProgress.ProgressText.Text = text or (current .. " / " .. total .. " scripts")
    end
    ...
    local function startScan()
        ...
        page.ExporterActions.ExportSelectedButton.Text = "Export Selected (0)"
        updateProgress(0, 1, "Scanning...")
        
        task.spawn(function()
            local total = scanScripts(game)
            updateProgress(0, total, "Decompiling...")
            
            for i, scriptData in ipairs(allScripts) do
                scriptData.source = decompileScript(scriptData.instance)
                updateProgress(i, total, "Decompiling " .. i .. "/" .. total)
                task.wait()
            end
            
            page.ExporterProgress.Visible = false
            updateScriptsList()
        end)
    end
    ...
    local function exportSelected()
        ...
        local basePath = "Ketamine_Exports/" .. gameId .. "/"
        
        if makefolder then
            pcall(makefolder, "Ketamine_Exports")
            pcall(makefolder, basePath)
        end
        
        page.ExporterProgress.Visible = true
        updateProgress(0, #selectedScripts, "Exporting...")
        
        local successCount = 0
        local failCount = 0
        
        for i, scriptData in ipairs(selectedScripts) do
            local fileName = scriptData.path:gsub("[^%w_]", "_") .. ".lua"
            local fullPath = basePath .. fileName
            
            local success, err = pcall(function()
                if writefile then
                    writefile(fullPath, scriptData.source)
                end
            end)
            ...
            updateProgress(i, #selectedScripts, "Exporting " .. i .. "/" .. #selectedScripts)
            task.wait()
        end
        
        page.ExporterProgress.Visible = false
        
        page.ExporterActions.ExportSelectedButton.Text = "Exported " .. successCount .. " (" .. failCount .. " failed)"
        task.wait(2)
        page.ExporterActions.ExportSelectedButton.Text = "Export Selected (" .. #selectedScripts .. ")"
    end
    
    page.ScanAllButton.MouseButton1Click:Connect(function()
        startScan()
    end)
    
    page.ExporterActions.ExportSelectedButton.MouseButton1Click:Connect(function()
        exportSelected()
    end)
    
    page.ExporterActions.SelectAllButton.MouseButton1Click:Connect(function()
        selectedScripts = {}
        for _, scriptData in ipairs(allScripts) do
            if filters[scriptData.type] then
                table.insert(selectedScripts, scriptData)
            end
        end
        page.ExporterActions.ExportSelectedButton.Text = "Export Selected (" .. #selectedScripts .. ")"
    ...
    page.SearchBox.SearchBox.FocusLost:Connect(function()
        updateScriptsList()
    end)
    
    page.ExporterFilters.FilterLocalScript.MouseButton1Click:Connect(function()
        filters.LocalScript = not filters.LocalScript
        page.ExporterFilters.FilterLocalScript.BackgroundColor3 = filters.LocalScript and Color3.new(0.160784, 0.505882, 0.333333) or Color3.new(0.3, 0.3, 0.3)
        updateScriptsList()
    end)
    
    page.ExporterFilters.FilterModuleScript.MouseButton1Click:Connect(function()
        filters.ModuleScript = not filters.ModuleScript
        page.ExporterFilters.FilterModuleScript.BackgroundColor3 = filters.ModuleScript and Color3.new(0.160784, 0.505882, 0.333333) or Color3.new(0.3, 0.3, 0.3)
        updateScriptsList()
    end)
    
    page.ExporterFilters.FilterScript.MouseButton1Click:Connect(function()
        filters.Script = not filters.Script
        page.ExporterFilters.FilterScript.BackgroundColor3 = filters.Script and Color3.new(0.160784, 0.505882, 0.333333) or Color3.new(0.3, 0.3, 0.3)
        updateScriptsList()
    end)
end
    end;
...
task.spawn(function()
    task.wait(1)
    local function addNavButton(name, label)
        ...
        btn.Text = ""
        btn.ZIndex = 1
        btn.Parent = script.Parent.Main.Contents.Buttons.Holder.List
        ...
        lbl.Name = "Label"
        lbl.Size = UDim2.new(0.65, 0, 0.4, 0)
        lbl.Position = UDim2.new(0.35, 0, 0.5, 0)
        ...
        lbl.Font = Enum.Font.TitilliumWeb
        lbl.TextSize = 14
        lbl.ZIndex = 1
        lbl.Parent = cut
        
        tweens[name] = {
            tweenService:Create(btn, TweenInfo.new(0.35), {BackgroundTransparency = 0.95}),
            tweenService:Create(btn, TweenInfo.new(0.35), {BackgroundTransparency = 1})
        }
        
        cons[#cons+1] = btn.MouseButton1Click:Connect(function()
            switchPage(name)
        end)
    ...
    addNavButton("ScriptExporter", "Script Exporter")
end)
...
if isMobile then
    ...
    if screenSize.X < 800 then
        mobileScale = 0.7
    elseif screenSize.X < 600 then
        mobileScale = 0.55
    end
    script.Parent.MobileScale.Scale = mobileScale
    script.Parent.Size = UDim2.fromScale(0.85, 0.85)
...
local function updateMobileScale()
    ...
    if newScale ~= mobileScale then
        mobileScale = newScale
        script.Parent.MobileScale.Scale = mobileScale
    end
end

cons[#cons + 1] = uis.WindowSize:Connect(updateMobileScale)

if isMobile then
    for _, btn in pairs(script.Parent.Main.Contents.Buttons.Holder.List:GetChildren()) do
        if btn:IsA("TextButton") then
            btn.Size = UDim2.new(1, 0, 0, 50)
        end
    end
    
    for _, pageBtn in pairs(script.Parent.Main.Contents.Pages:GetChildren()) do
        if pageBtn:IsA("Frame") then
            for _, child in pairs(pageBtn:GetDescendants()) do
                if child:IsA("TextButton") and child.Name ~= "TextBox" then
                    local currentSize = child.Size
                    if currentSize.Y.Offset < 44 then
                        child.Size = UDim2.new(currentSize.X.Scale, currentSize.X.Offset, 0, 44)
                    end
                end
...
if isMobile then
    local pageOrder = {"Home", "ScriptScanner", "MemoryScanner", "RSpy", "ESpy", "HTTPSpy", "ScriptExporter", "Settings"}
    ...
    local swipeSensitivity = 50
    
    local function handleSwipe(input)
        if not isMobile then return end
        if input.UserInputType == Enum.UserInputType.Touch then
            if input.Position.X - swipeStartX > swipeSensitivity then
                local idx = getCurrentPageIndex()
                if idx > 1 then
                    switchPage(pageOrder[idx - 1])
                    currentPageIndex = idx - 1
                end
                swipeStartX = nil
            elseif swipeStartX - input.Position.X > swipeSensitivity then
                local idx = getCurrentPageIndex()
                if idx < #pageOrder then
                    switchPage(pageOrder[idx + 1])
                    currentPageIndex = idx + 1
                end
                swipeStartX = nil
    ...
    cons[#cons + 1] = script.Parent.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch then
            swipeStartX = input.Position.X
        end
    end)
    
    cons[#cons + 1] = script.Parent.InputEnded:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch and swipeStartX then
            handleSwipe(input)
        end
    end)
    
    local codeViewScales = {}
    local initialPinchDistance = nil
    local initialScales = {}
    
    local function getPinchDistance(touches)
        if #touches < 2 then return nil end
    ...
    local function findTextBoxInPage(page)
        for _, child in pairs(page:GetDescendants()) do
            if child:IsA("TextBox") and child.Name == "TextBox" then
                local parent = child.Parent
                if parent and parent.Name == "Editor" then
                    return child
                end
            end
        end
    ...
    cons[#cons + 1] = uis.InputChanged:Connect(function(input, gameProcessed)
        if not gameProcessed then return end
        if input.UserInputType == Enum.UserInputType.TouchCount then
            local touches = uis:GetTouches()
            if #touches >= 2 then
                local currentDistance = getPinchDistance(touches)
                if not initialPinchDistance then
                    initialPinchDistance = currentDistance
                    for _, page in pairs(script.Parent.Main.Contents.Pages:GetChildren()) do
                        if page:IsA("Frame") then
                            local textBox = findTextBoxInPage(page)
                            if textBox and textBox.Parent and textBox.Parent:FindFirstChild("UIScale") then
                                initialScales[page.Name] = textBox.Parent.UIScale.Scale
                            else
                                initialScales[page.Name] = 1
                            end
                        end
                    end
                elseif initialPinchDistance > 0 then
                    local scaleFactor = currentDistance / initialPinchDistance
                    for _, page in pairs(script.Parent.Main.Contents.Pages:GetChildren()) do
                        if page:IsA("Frame") and initialScales[page.Name] then
                            local textBox = findTextBoxInPage(page)
                            if textBox and textBox.Parent then
                                local newScale = math.clamp(initialScales[page.Name] * scaleFactor, 0.5, 3)
                                if not textBox.Parent:FindFirstChild("UIScale") then
                                    local us = Instance.new("UIScale")
                                    us.Name = "CodeScale"
                                    us.Parent = textBox.Parent
                                    us.Scale = newScale
                                else
                                    textBox.Parent.UIScale.Scale = newScale
                end
            end
        end
        
        local function triggerHapticFeedback()
            if isMobile and uis.TouchEnabled then
                local success, _ = pcall(function()
                    local haptic = uis:GetPlatformEnabled(Enum.Platform.XBoxOne)
                    if haptic then
                        uis:ReleaseInput(Enum.InputType.Gamepad1)
                    end
                end)
            end
        end
    ...
    if isMobile then
        local fab = script.Parent.FloatingActionButton
        fab.Visible = true
        
        local fabActions = {}
        local fabExpanded = false
        
        local function createFABAction(position, icon, callback)
            local action = Instance.new("Frame")
            action.Name = "FABAction"
            action.Size = UDim2.new(0, 40, 0, 40)
            action.Position = position
            action.BackgroundColor3 = Color3.new(0.2, 0.2, 0.2)
            ...
            btn.MouseButton1Click:Connect(function()
                callback()
                fabExpanded = false
                for _, a in pairs(fabActions) do
                    a.Visible = false
                end
            end)
            
            action.Parent = fab
            table.insert(fabActions, action)
            return action
        end
        
        createFABAction(UDim2.new(0.5, 0, 0, -50), "rbxassetid://7733658504", function()
            switchPage("Home")
        end)
        
        createFABAction(UDim2.new(0.5, 0, 0, -100), "rbxassetid://7733618137", function()
            switchPage("ScriptScanner")
        end)
        
        createFABAction(UDim2.new(0.5, 0, 0, -150), "rbxassetid://7733618137", function()
            switchPage("ScriptExporter")
        end)
        
        createFABAction(UDim2.new(0.5, 0, 0, -200), "rbxassetid://7733625348", function()
            if isMinimized then
                maximize()
            end
        end)
        ...
        fabBtn.MouseButton1Click:Connect(function()
            fabExpanded = not fabExpanded
            for i, action in pairs(fabActions) do
                action.Visible = fabExpanded
                if fabExpanded then
                    action:TweenPosition(UDim2.new(0.5, 0, 0, -50 * i), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
                end
            end
        end)
    end
    ...
    if isMobile then
        for _, page in pairs(script.Parent.Main.Contents.Pages:GetChildren()) do
            if page:IsA("Frame") then
                for _, child in pairs(page:GetDescendants()) do
                    if child:IsA("ScrollingFrame") then
                        child.ScrollBarThickness = 10
                        child.ElasticBehavior = Enum.ElasticBehavior.Always
                    end
                end
            end
        end
        
        for _, child in pairs(script.Parent.Main.Contents:GetDescendants()) do
            if child:IsA("ScrollingFrame") then
                child.ScrollBarThickness = 10
                child.ElasticBehavior = Enum.ElasticBehavior.Always
            end
            ...
            if page:IsA("Frame") then
                for _, child in pairs(page:GetDescendants()) do
                    if child:IsA("TextBox") then
                        child.Size = UDim2.new(child.Size.X.Scale, child.Size.X.Offset, 0, math.max(child.Size.Y.Offset, 44))
                        child.TextSize = math.max(child.TextSize, 16)
                    end
                end
            end
        end
        
        local bottomNav = script.Parent.BottomNavBar
        bottomNav.Visible = true
        bottomNav.Position = UDim2.new(0.5, 0, 1, 0)
        
        local sidePanel = script.Parent.Main.Contents.Buttons
        sidePanel.Visible = false
        
        local navItems = {
            {name = "Home", icon = "rbxassetid://7733658504"},
            {name = "ScriptScanner", icon = "rbxassetid://7733618137"},
            {name = "ScriptExporter", icon = "rbxassetid://7733618137"},
            {name = "MemoryScanner", icon = "rbxassetid://7733625300"},
            {name = "Settings", icon = "rbxassetid://7733658504"}
        }
        
        for i, item in ipairs(navItems) do
            local navBtn = Instance.new("Frame")
            navBtn.Name = item.name .. "Nav"
            navBtn.Size = UDim2.new(0, 50, 0, 44)
            ...
            img.AnchorPoint = Vector2.new(0.5, 0.5)
            img.Image = item.icon
            img.ImageColor3 = Color3.new(0.6, 0.6, 0.6)
            img.BackgroundTransparency = 1
            img.ZIndex = 53
            img.Parent = navBtn
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                for _, child in pairs(bottomNav.BottomNavContent:GetChildren()) do
                    if child:IsA("Frame") then
                        for _, c in pairs(child:GetChildren()) do
                            if c:IsA("ImageLabel") then
                                c.ImageColor3 = Color3.new(0.6, 0.6, 0.6)
                            end
                        end
                    end
                end
            ...
            navBtn.Parent = bottomNav.BottomNavContent
        end
        
        script.Parent.Main.Contents.Pages.Position = UDim2.new(0.2, 0, 0.1, 0)
        script.Parent.Main.Contents.Pages.Size = UDim2.new(0.8, 0, 0.85, 0)
        
        script.Parent.AnchorPoint = Vector2.new(0.5, 0.5)
        script.Parent.Position = UDim2.new(0.5, 0, 0.5, 0)
        
        local tooltip = Instance.new("Frame")
        tooltip.Name = "MobileTooltip"
        tooltip.Size = UDim2.new(0.8, 0, 0, 80)
        tooltip.Position = UDim2.new(0.1, 0, 0.1, 0)
        ...
        tooltipCorner.CornerRadius = UDim.new(0.05, 0)
        ...
        tooltipText.Text = "Welcome to Ketamine!\nSwipe left/right to navigate tabs.\nPinch to zoom code. Tap FAB for quick actions."
        ...
        local tooltipClose = Instance.new("TextButton")
        tooltipClose.Size = UDim2.new(0, 30, 0, 30)
        tooltipClose.Position = UDim2.new(1, -10, 0, 10)
        tooltipClose.AnchorPoint = Vector2.new(1, 0)
        tooltipClose.BackgroundTransparency = 1
        tooltipClose.Text = "X"
        tooltipClose.TextColor3 = Color3.new(1, 1, 1)
        tooltipClose.TextSize = 18
        tooltipClose.ZIndex = 1002
        tooltipClose.Parent = tooltip
        
        tooltipClose.MouseButton1Click:Connect(function()
            tooltip.Visible = false
        end)
        
        tooltip.Parent = script.Parent
