...
do -- Set properties
    ...
    objects["Instance312"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
    ...
    objects["Instance312"]["HorizontalFlex"] = Enum.UIFlexAlignment.SpaceEvenly;
...
return function(shared, page)
    ...
    local function updateScriptsList()
        local searchText = page.ExporterFilters.SearchField.SearchBox.Text:lower()
    ...
    page.ExporterHeader.ScanAllButton.MouseButton1Click:Connect(function()
        startScan()
    end)
    ...
    page.ExporterFilters.SearchField.SearchBox.FocusLost:Connect(function()
        updateScriptsList()
    end)
